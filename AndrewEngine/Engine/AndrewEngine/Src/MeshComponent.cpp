...
void MeshComponent::CreatePlane(int rows, int collums, float size)
{
    mMesh = MeshBuilder::CreatePlane(rows, collums, size);
}
...
const Graphics::RenderObject& AndrewEngine::MeshComponent::GetRenderObject() const 
{
