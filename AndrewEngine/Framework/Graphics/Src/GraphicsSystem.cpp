...
AndrewEngine::Graphics::GraphicsSystem::~GraphicsSystem()
{
...
void AndrewEngine::Graphics::GraphicsSystem::Terminate()
{
...
void AndrewEngine::Graphics::GraphicsSystem::EndRender()
{
    mSwapChain->Present(mVSync, 0);
}

void AndrewEngine::Graphics::GraphicsSystem::ToggleFullscreen()
{
    BOOL fullScreen;
...
void AndrewEngine::Graphics::GraphicsSystem::Resize(uint32_t width, uint32_t height)
{
...
void AndrewEngine::Graphics::GraphicsSystem::ResetRenderTarget()
{
    mImmediateContext->OMSetRenderTargets(1, &mRenderTargetView, mDepthStencilView);
}

void AndrewEngine::Graphics::GraphicsSystem::ResetViewport()
{
    mImmediateContext->RSSetViewports(1, &mViewport);
}

void AndrewEngine::Graphics::GraphicsSystem::SetClearColour(Color clearColour)
{
    mClearColour = clearColour;
}

void AndrewEngine::Graphics::GraphicsSystem::SetVSync(bool vSync)
{
    mVSync = vSync ? 1 : 0;
}

uint32_t AndrewEngine::Graphics::GraphicsSystem::GetBackBufferWidth() const
{
    return mSwapChainDesc.BufferDesc.Width;
}

uint32_t AndrewEngine::Graphics::GraphicsSystem::GetBackBufferHeight() const
{
    return mSwapChainDesc.BufferDesc.Height;
}

float AndrewEngine::Graphics::GraphicsSystem::GetBackBufferAspectRatio() const
{
